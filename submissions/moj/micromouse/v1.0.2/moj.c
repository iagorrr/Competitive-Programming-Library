# 0 "main.c"
# 1 "/home/iagorrr/code/micromouse/bobita-comunista//"
# 0 "<built-in>"
# 0 "<command-line>"
...
map_cell __MAP[(unsigned int)30 * 2][(unsigned int)30 * 2];

coord translate(coord *c) {
        return (coord){c->i + (unsigned int)30, c->j + (unsigned int)30};
}
...
# 43 "main.c"
                ,
                "Deveria ter chegado no goal aí hein\n");
        fprintf(
# 44 "main.c" 3 4
                stderr
# 44 "main.c"
