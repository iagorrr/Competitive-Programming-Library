...
int main()
{
  ...
  while(t--) {
    ...
    std::vector<char> inorder(a.begin(), a.end());
    std::vector<char> preorder(b.begin(), b.end());
    BST<char> bst(inorder, preorder);
    bst.postorder(foo); std::cout << '\n';
  }

}

// AC, binary tree reconstruction.
